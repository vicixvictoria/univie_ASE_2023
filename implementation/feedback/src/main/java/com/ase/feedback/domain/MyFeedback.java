...
public class MyFeedback {
    ...
    public MyFeedback(String eventID, String userID, int ratingOverall, int ratingFood,
    ...
    public MyFeedback(String feedbackID, String eventID, String userID, int ratingOverall, int ratingFood,
            int ratingLocation, String comment) {
