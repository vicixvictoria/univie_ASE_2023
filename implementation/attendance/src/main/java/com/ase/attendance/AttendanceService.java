...
public class AttendanceService {
     ...
     */
     int register(String userID, String eventID) {
     ...
     * @return the updated count of attendees for the event.
     */
     int deregister(String userID, String eventID) {
     ...
     */
     AttendeeEventList getEventList(String userID) {
