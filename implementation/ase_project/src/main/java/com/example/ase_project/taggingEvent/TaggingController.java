...
public class TaggingController {
    ...
    public TaggingEvent addEventTag(@PathVariable String eventId, @PathVariable String userId, @PathVariable ETags addEventTag) {
    ...
    public TaggingEvent removeEventTag(@PathVariable String eventId, @PathVariable String userId, @PathVariable ETags eventTag) {
